...
powershell -NoProfile -Command "Start-Process -FilePath 'wsl.exe' -ArgumentList '-e','bash','/mnt/d/projects/flink-realtime-analysis/start-all.sh' -WindowStyle Hidden"
:waitcluster
...
wsl -e bash -c "cd ~/flinkRT/flink-1.20.5 && nohup bin/flink run -c com.example.realtime.RealtimeAnalysisJob /mnt/d/projects/flink-realtime-analysis/flink-job/target/realtime-analysis-1.0.jar --kafka 127.0.0.1:9092 --clickhouse 'jdbc:clickhouse://172.31.192.1:8124/rt' > /tmp/submit.log 2>&1 & sleep 25"
...
echo     wsl -e bash -c "cd /mnt/d/projects/flink-realtime-analysis/producer && python3 replay_producer.py --file ~/userbehavior_tianchi.csv --rate 0 --bootstrap 127.0.0.1:9092"
